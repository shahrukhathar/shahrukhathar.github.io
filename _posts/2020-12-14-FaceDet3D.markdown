...
<div align="center">
  <br>
  <h3><i><b>TL;DR </b> From single images, we predict facial geometric details that are consistent with any given target expression and photo-realistically render them using Neural Rendering.</i></h3>
  <br>
  <br>
</div>
